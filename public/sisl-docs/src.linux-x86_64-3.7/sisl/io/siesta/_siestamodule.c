 ...
 * Generation date: Tue Aug  4 19:14:19 2020
...
/*frompyobj*/
  ...
  if (capi_isc_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `isc' of _siesta.siesta_sc_off to C/Fortran array" );
...
/*frompyobj*/
  ...
  if (capi_numh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `numh' of _siesta.read_hsx_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_listh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `listh' of _siesta.read_hsx_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `h' of _siesta.read_hsx_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_hsx_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_xij_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `xij' of _siesta.read_hsx_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_numh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `numh' of _siesta.read_hsx_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    numh = (int *)(PyArray_DATA(capi_numh_tmp));
  ...
  if (capi_listh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `listh' of _siesta.read_hsx_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    listh = (int *)(PyArray_DATA(capi_listh_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_hsx_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (float *)(PyArray_DATA(capi_s_tmp));
...
/*frompyobj*/
  ...
  if (capi_listh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 6th argument `listh' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    listh = (int *)(PyArray_DATA(capi_listh_tmp));
  ...
  if (capi_numh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `numh' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    numh = (int *)(PyArray_DATA(capi_numh_tmp));
  ...
  if (capi_listhptr_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `listhptr' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 7th argument `h' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 8th argument `s' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_xij_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 9th argument `xij' of _siesta.write_hsx to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `nsc' of _siesta.read_dm_sizes to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `nsc' of _siesta.read_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `ncol' of _siesta.read_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `list_col' of _siesta.read_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_dm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `dm' of _siesta.read_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 2nd argument `nsc' of _siesta.write_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 3rd argument `ncol' of _siesta.write_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `list_col' of _siesta.write_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_dm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `dm' of _siesta.write_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dm = (double *)(PyArray_DATA(capi_dm_tmp));
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `nsc' of _siesta.read_tshs_cell to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_cell_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `cell' of _siesta.read_tshs_cell to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_isc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `isc' of _siesta.read_tshs_cell to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    isc = (int *)(PyArray_DATA(capi_isc_tmp));
...
/*frompyobj*/
  ...
  if (capi_xa_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `xa' of _siesta.read_tshs_geom to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_lasto_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `lasto' of _siesta.read_tshs_geom to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `ncol' of _siesta.read_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `list_col' of _siesta.read_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `h' of _siesta.read_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    h = (double *)(PyArray_DATA(capi_h_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));
...
/*frompyobj*/
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `ncol' of _siesta.read_tshs_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `list_col' of _siesta.read_tshs_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_tshs_s to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));
...
/*frompyobj*/
  ...
  if (capi_cell_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `cell' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    cell = (double *)(PyArray_DATA(capi_cell_tmp));
  ...
  if (capi_xa_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 6th argument `xa' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    xa = (double *)(PyArray_DATA(capi_xa_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 8th argument `ncol' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 9th argument `list_col' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_lasto_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 7th argument `lasto' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    lasto = (int *)(PyArray_DATA(capi_lasto_tmp));
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 10th argument `h' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    h = (double *)(PyArray_DATA(capi_h_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 11st argument `s' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));
  ...
  if (capi_isc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 12nd argument `isc' of _siesta.write_tshs_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    isc = (int *)(PyArray_DATA(capi_isc_tmp));
...
/*frompyobj*/
  ...
  if (capi_mesh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `mesh' of _siesta.read_grid_sizes to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_cell_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `cell' of _siesta.read_grid_cell to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    cell = (double *)(PyArray_DATA(capi_cell_tmp));
...
/*frompyobj*/
  ...
  if (capi_grid_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `grid' of _siesta.read_grid to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_cell_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 3rd argument `cell' of _siesta.write_grid to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    cell = (double *)(PyArray_DATA(capi_cell_tmp));
  ...
  if (capi_grid_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `grid' of _siesta.write_grid to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    grid = (float *)(PyArray_DATA(capi_grid_tmp));
...
/*frompyobj*/
  ...
  if (capi_kpt_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `kpt' of _siesta.read_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_e_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `e' of _siesta.read_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `h' of _siesta.read_gf_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_gf_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_se_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `se' of _siesta.read_gf_se to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_cell_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 3rd argument `cell' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    cell = (double *)(PyArray_DATA(capi_cell_tmp));
  ...
  if (capi_xa_used_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 7th argument `xa_used' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_bloch_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 9th argument `bloch' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_kpt_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 12nd argument `kpt' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    kpt = (double *)(PyArray_DATA(capi_kpt_tmp));
  ...
  if (capi_e_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 14th argument `e' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    e = (complex_double *)(PyArray_DATA(capi_e_tmp));
  ...
  if (capi_lasto_used_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 8th argument `lasto_used' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_kw_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 13rd argument `kw' of _siesta.write_gf_header to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `h' of _siesta.write_gf_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    h = (complex_double *)(PyArray_DATA(capi_h_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `s' of _siesta.write_gf_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (complex_double *)(PyArray_DATA(capi_s_tmp));
...
/*frompyobj*/
  ...
  if (capi_se_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `se' of _siesta.write_gf_se to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    se = (complex_double *)(PyArray_DATA(capi_se_tmp));
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `nsc' of _siesta.read_tsde_sizes to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `nsc' of _siesta.read_tsde_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `ncol' of _siesta.read_tsde_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `list_col' of _siesta.read_tsde_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_dm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `dm' of _siesta.read_tsde_dm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dm = (double *)(PyArray_DATA(capi_dm_tmp));
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `nsc' of _siesta.read_tsde_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `ncol' of _siesta.read_tsde_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `list_col' of _siesta.read_tsde_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_edm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `edm' of _siesta.read_tsde_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_nsc_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 2nd argument `nsc' of _siesta.write_tsde_dm_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nsc = (int *)(PyArray_DATA(capi_nsc_tmp));
  ...
  if (capi_ncol_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 3rd argument `ncol' of _siesta.write_tsde_dm_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ncol = (int *)(PyArray_DATA(capi_ncol_tmp));
  ...
  if (capi_list_col_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 4th argument `list_col' of _siesta.write_tsde_dm_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    list_col = (int *)(PyArray_DATA(capi_list_col_tmp));
  ...
  if (capi_dm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 5th argument `dm' of _siesta.write_tsde_dm_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dm = (double *)(PyArray_DATA(capi_dm_tmp));
  ...
  if (capi_edm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting 6th argument `edm' of _siesta.write_tsde_dm_edm to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    edm = (double *)(PyArray_DATA(capi_edm_tmp));
...
/*frompyobj*/
  ...
  if (capi_listh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `listh' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    listh = (int *)(PyArray_DATA(capi_listh_tmp));
  ...
  if (capi_numh_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `numh' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    numh = (int *)(PyArray_DATA(capi_numh_tmp));
  ...
  if (capi_listhptr_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `listhptr' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    listhptr = (int *)(PyArray_DATA(capi_listhptr_tmp));
  ...
  if (capi_h_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `h' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    h = (double *)(PyArray_DATA(capi_h_tmp));
  ...
  if (capi_s_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `s' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    s = (double *)(PyArray_DATA(capi_s_tmp));
  ...
  if (capi_xij_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `xij' of _siesta.read_hs to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    xij = (double *)(PyArray_DATA(capi_xij_tmp));
...
/*frompyobj*/
  ...
  if (capi_k_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `k' of _siesta.read_wfsx_index_info to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_idx_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `idx' of _siesta.read_wfsx_index_1 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_eig_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `eig' of _siesta.read_wfsx_index_1 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_state_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `state' of _siesta.read_wfsx_index_1 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_idx_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `idx' of _siesta.read_wfsx_index_2 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    idx = (int *)(PyArray_DATA(capi_idx_tmp));
  ...
  if (capi_eig_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `eig' of _siesta.read_wfsx_index_2 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    eig = (double *)(PyArray_DATA(capi_eig_tmp));
  ...
  if (capi_state_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `state' of _siesta.read_wfsx_index_2 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_idx_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `idx' of _siesta.read_wfsx_index_4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    idx = (int *)(PyArray_DATA(capi_idx_tmp));
  ...
  if (capi_eig_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `eig' of _siesta.read_wfsx_index_4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    eig = (double *)(PyArray_DATA(capi_eig_tmp));
  ...
  if (capi_state_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _siesta_error,"failed in converting hidden `state' of _siesta.read_wfsx_index_4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    state = (complex_float *)(PyArray_DATA(capi_state_tmp));
...
PyMODINIT_FUNC PyInit__siesta(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _siesta (failed to import numpy)"); return m;}
...
"Fortran 90/95 modules:\n""  io_m --- open_file(),close_file(),open_file_read(),open_file_write(),rewind_file(),iostat_reset(),iostat_update(),iostat_query()"".");
   ...
   */
  PyDict_SetItemString(d, "__siesta_error", _siesta_error);
  Py_DECREF(_siesta_error);
